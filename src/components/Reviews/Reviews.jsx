...
import { loadReviewByRestaurantIdIfNotExist } from '../../store/modules/review/thunk/loadReviewsByRestaurantIdIfNotExist';
...
export const Reviews = ({ restaurantId }) => {
  ...
  useEffect(() => {
    dispatch(loadReviewByRestaurantIdIfNotExist(restaurantId));
  }, [restaurantId]);
