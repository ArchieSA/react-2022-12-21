...
import { loadReviewsIfNotExist } from './modules/review/middleware/loadReviewsIfNotExist';
...
export const store = createStore(rootReducer, applyMiddleware(logger, loadRestaurantsIfNotExist, loadDishByRestaurantIdIfNotExist, loadReviewsIfNotExist, loadUsersIfNotExist));
